...
const features = [
  {
    name: 'Projects',
    description:
      'Click here to see some recent projects we have been involved in the development of. These include various academic exercises by team members and some live creations. Click below to see the gallery for more',
    href: '/Projects',
