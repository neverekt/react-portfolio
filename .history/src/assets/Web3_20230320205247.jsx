        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Regardless of you or your company's existing infrastructure, you will be aware of the potential benefits of deploying alternative workflows that make use of smart contracts that can automate certain business processes
            </p>
          </div>
