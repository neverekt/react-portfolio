...
const features = [
  ...
  },
  {
    ...
    description: 'We can train custom language models for your specific use-case from a variety of starting formats. You can then query this using an API and we will help you update it as new information comes in ',
    icon: ServerIcon,
  },
]
